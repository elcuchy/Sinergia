...
yay -S stacer-bin gnome-shell-extension-dash2dock-lite gnome-shell-extension-compiz-alike-magic-lamp-effect-git gnome-shell-extension-arc-menu-git gnome-shell-extension-burn-my-windows --noconfirm
