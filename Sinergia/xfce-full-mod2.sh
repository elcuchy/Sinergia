...
pacman-key --recv-keys 149ABD0C3A0563EE --keyserver keyserver.ubuntu.com || \
pacman-key --recv-keys 149ABD0C3A0563EE --keyserver keys.openpgp.org

pacman-key --lsign-key 149ABD0C3A0563EE

echo "==> Instalando kiro-keyring y kiro-mirrorlist..."
pacman -Sy --needed kiro-keyring kiro-mirrorlist --noconfirm

echo "==> Actualizando pacman.conf para usar kiro-mirrorlist..."
sed -i 's|Server = https://erikdubois.github.io/\$repo/\$arch|Include = /etc/pacman.d/kiro-mirrorlist|g' /etc/pacman.conf
...
# ==========================================
echo "==> Asegurando base-devel e instalando YAY (como usuario sin root)..."
pacman -S --needed base-devel git --noconfirm

# Ejecutar la compilación de YAY con el usuario normal
