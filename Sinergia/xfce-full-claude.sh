...
# ==========================================
# 7. APLICACIÓN DEL PERFIL REDMOND
# ==========================================
echo "==> Cargando el perfil Redmond en el usuario $REAL_USER..."

LAYOUT_FILE="/usr/share/xfce4-panel-profiles/layouts/redmond.tar.bz2"
...
# También se extrae en /etc/skel para que futuros usuarios hereden Redmond
