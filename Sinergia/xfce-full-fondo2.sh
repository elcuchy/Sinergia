...
# ==========================================
echo "==> Personalizando apariencia (Graphite-Dark, Yaru-Teal, Transparencia)..."
...
<channel name="xsettings" version="1.0">
  <property name="Net" type="empty">
    ...
    <property name="IconThemeName" type="string" value="Yaru-Teal"/>
  </property>
...
echo " Icon theme: Yaru-Teal con ícono de lanzador: $LAUNCHER_ICON"
