...
# ==========================================
# 4. INSTALACIÓN DE PAQUETES OFICIALES, PLANK Y CHAOTIC-AUR
# ==========================================
echo "==> Instalando XFCE, Plank, aplicaciones y paquetes del sistema..."
...
# ==========================================
# 6. CONFIGURACIÓN DE APARIENCIA, PANEL Y PLANK
# ==========================================
echo "==> Limpiando paneles antiguos y configurando Plank + Barra Superior..."
...
EOF
    ...
    # 2. Panel superior único (Sustituye Panel 1 y 2 por un panel superior para tray/menú)
...
EOF
    ...
    # 3. Configuración del Autostart para Plank
    $SUDO_CMD tee "$TARGET_DIR/autostart/plank.desktop" > /dev/null << 'EOF'
[Desktop Entry]
Type=Application
Exec=plank
Hidden=false
