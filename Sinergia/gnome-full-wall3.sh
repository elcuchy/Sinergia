...
WALLPAPER_URL_169="https://raw.githubusercontent.com/UncleSpellbinder/Arch-Linux-HD-Wallpaper/main/ARCH_12__1920x1080.jpg"
...
if [ "$ASPECT_X100" -ge 200 ]; then
    ...
    WALLPAPER_PATH="/usr/share/backgrounds/gnome-sinergia-wallpaper-16x9.jpg"
fi
